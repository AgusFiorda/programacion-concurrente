...
hilo1 = threading.Thread(target=crearAnimacion, args=(10, 10, "X"))
hilo2 = threading.Thread(target=crearAnimacion, args=(10, 30, "Y"))
hilo3 = threading.Thread(target=crearAnimacion, args=(10, 50, "Z"))
