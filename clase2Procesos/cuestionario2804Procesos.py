...
if __name__ == "__main__":
    freeze_support()
    process1 = Process(target=crearAnimacion, args=(10, 10, "X"))
    process2 = Process(target=crearAnimacion, args=(10, 30, "Y"))
    process3 = Process(target=crearAnimacion, args=(10, 50, "Z"))
